            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-6 p-6">
              ...
              <div className="md:col-span-4 space-y-4 md:border-r md:pr-6 border-slate-100 dark:border-slate-800">
                ...
                <div className="p-3 rounded-lg border border-slate-100 dark:border-slate-800 bg-slate-50/30 dark:bg-slate-900/10 flex items-start gap-2.5">
                  ...
                  <div>
                    <span className="text-[10px] text-slate-400 font-semibold block">Level Linkage</span>
                    <span className="text-xs font-bold text-slate-800 dark:text-slate-200">
                      {question.level?.title_en || <span className="text-slate-400 font-normal">None (Unassigned)</span>}
                    </span>
                  </div>
                </div>
