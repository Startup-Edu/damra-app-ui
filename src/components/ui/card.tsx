  ...
  return (
    <div
      ...
      className={cn(
        ...
        variant === "glass" && "border-border/50 bg-card/70 backdrop-blur-2xl shadow-[0_8px_40px_rgb(0,0,0,0.08)] dark:shadow-[0_8px_40px_rgb(0,0,0,0.2)] rounded-2xl border ring-0",
        className
      )}
      {...props}
    />
